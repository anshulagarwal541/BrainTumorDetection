...
import { admin_login2 } from '../../../public'
            ...
            <div className='flex flex-col sm:flex-row w-full sm:w-[80%] gap-2'>
                ...
                <div className='flex justify-center items-center sm:w-1/2'>
                    <div className='h-fit sm:h-full'>
                        <img src={admin_login2} alt="add_patient" className="w-full h-full object-cover rounded-lg" />
                    </div>
                </div>
                ...
                <div className='flex w-full sm:w-1/2'>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-2">
                            <p className='font-bold flex gap-5 items-center'>Login as User ?
                                <Link to="/login/user">
